...
#define MyAppName "红警自动"
#define MyAppVersion "1.3.3"
#define MyAppExeName "启动.exe"

[Setup]
;注意：AppId 的值唯一标识此应用程序。请勿在安装程序中对其他应用程序使用相同的 AppId 值。
;（若要生成新的 GUID，请单击“工具”|”在 IDE 中生成 GUID）。
AppId={{8FC019CB-A07A-4064-A4C5-18F6EC361E38}
AppName={#MyAppName}
...
Source: "Qt5Core.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "Qt5Gui.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "Qt5Widgets.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "Qt5Network.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "opencv_core4100.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "opencv_imgcodecs4100.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "opencv_imgproc4100.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "msvcp140.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "msvcp140_1.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "vcruntime140.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
Source: "vcruntime140_1.dll"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full
